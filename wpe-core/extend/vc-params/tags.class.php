...
if(!class_exists('BestBug_Extend_VcParams_Tags'))
{
	class BestBug_Extend_VcParams_Tags
	{
		...
		function init()
		{
			if ( class_exists( 'WpbakeryShortcodeParams' ) && is_admin() )
			{
				...
				if(is_admin()) {
					...
					WpbakeryShortcodeParams::addField('bb_tags' , array($this, 'bb_tags'), WPE_CORE_URL . '/assets/admin/js/extend/vc-params/tags.js');
				}
			}
		}
		...
		public function adminEnqueueScripts() {
			...
			wp_enqueue_style( 'bb-tags', WPE_CORE_URL . '/assets/admin/css/extend/vc-params/tags.css' );
