...
if(!class_exists('BestBug_Extend_VcParams_Tabs'))
{
	class BestBug_Extend_VcParams_Tabs
	{
		...
		function init()
		{
			...
			{
				WpbakeryShortcodeParams::addField('bb_tabs' , array($this, 'bb_tabs'), WPE_CORE_URL . '/assets/admin/js/extend/vc-params/tabs.js');
		...
		public function adminEnqueueScripts() {
			wp_enqueue_style( 'bb-tabs', WPE_CORE_URL . '/assets/admin/css/extend/vc-params/tabs.css' );
		}
